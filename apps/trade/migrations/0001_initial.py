# Generated by Django 2.2.16 on 2020-11-27 00:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_FINISHED', '交易结束'), ('TRADE_SUCCESS', '成功'), ('TRADE_CLOSED', '超时关闭'), ('paying', '待支付'), ('WAIT_BUYER_PAY', '交易创建')], default='paying', max_length=30, verbose_name='订单状态')),
